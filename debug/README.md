...
TOKEN=$(curl -k -s -X POST "https://localhost/suite-api/api/auth/token/acquire" \
  -H "Content-Type: application/json" \
  -d '{"username":"admin","password":"Xc7#Gw3@!fxD5vKy4x","authSource":"LOCAL"}' \
...
curl -k -s "https://localhost/suite-api/api/adapterkinds" \
  -H "Authorization: vRealizeOpsToken c975ecbe-bf6d-46e0-bece-d089cc674581::3641642c-c727-40fd-91e6-7c3f87f90a0f" \
